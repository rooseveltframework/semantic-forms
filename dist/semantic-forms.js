...
/***/90:
/***/(module,__unused_webpack_exports,__webpack_require__)=>{const{shortcutListener,createKeyboardShortcut}=__webpack_require__(497);const{enhanceInput}=__webpack_require__(866);const semanticForms=()=>{
...
const inputs=Array.from(form.querySelectorAll("input, textarea, select"));for(const input of inputs){enhanceInput(input);
...
const shiftClearBtn=()=>{const clearBtn=input.parentElement?.querySelector("button.clear");if(clearBtn)clearBtn.style.marginRight=input.clientHeight<input.scrollHeight?"15px":""};input.addEventListener("input",shiftClearBtn);input.addEventListener("mouseup",shiftClearBtn);shiftClearBtn()}}};module.exports={enhanceInput}
/***/}
/******/};
/************************************************************************/
/******/ // The module cache
