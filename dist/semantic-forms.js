...
document.addEventListener("keydown",e=>{const specialCharMap={Minus:"-",Equal:"=",BracketLeft:"[",BracketRight:"]",Backslash:"\\",Semicolon:";",Quote:"'",Comma:",",Period:".",Slash:"/",Backquote:"`"};const shiftSpecialCharMap={1:"!",2:"@",3:"#",4:"$",5:"%",6:"^",7:"&",8:"*",9:"(",0:")",Minus:"_",Equal:"+",BracketLeft:"{",BracketRight:"}",Backslash:"|",Semicolon:":",Quote:'"',Comma:"<",Period:">",Slash:"?",Backquote:"~"};const command=keyCommands.find(command=>{let matchesKey=false;if(e.altKey&&!e.shiftKey)
// mac adjusts the key value if altKey is pressed
matchesKey="Key"+command.key.toUpperCase()===e.code||"Digit"+command.key.toUpperCase()===e.code||command.key===e.key||specialCharMap[e.code]===command.key;else if(e.shiftKey){
